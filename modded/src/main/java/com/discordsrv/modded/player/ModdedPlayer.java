...
public class ModdedPlayer extends ModdedCommandSender implements IPlayer {

    private final ServerPlayer player;

    public ModdedPlayer(ModdedDiscordSRV discordSRV, ServerPlayer player) {
